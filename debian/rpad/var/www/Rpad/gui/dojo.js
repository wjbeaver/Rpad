...
for(var i=0;i<this.children.length;i++){
var _692=this.children[i];
if(_692 instanceof dojo.widget.html.Toolbar){
var item=_692.getItem(name);
if(item){
return item;
}
}
...
var _694=[];
for(var i=0;i<this.children.length;i++){
var _696=this.children[i];
if(_696 instanceof dojo.widget.html.Toolbar){
_694=_694.concat(_696.getItems());
}
}
return _694;
};
...
for(var i=0;i<this.children.length;i++){
var _698=this.children[i];
if(_698 instanceof dojo.widget.html.Toolbar){
_698.enable.apply(_698,arguments);
}
}
};
this.disable=function(){
for(var i=0;i<this.children.length;i++){
var _69a=this.children[i];
if(_69a instanceof dojo.widget.html.Toolbar){
_69a.disable.apply(_69a,arguments);
}
}
};
this.select=function(name){
for(var i=0;i<this.children.length;i++){
var _69d=this.children[i];
if(_69d instanceof dojo.widget.html.Toolbar){
_69d.select(arguments);
}
}
};
this.deselect=function(name){
for(var i=0;i<this.children.length;i++){
var _6a0=this.children[i];
if(_6a0 instanceof dojo.widget.html.Toolbar){
_6a0.deselect(arguments);
}
}
};
...
var _6a1={};
for(var i=0;i<this.children.length;i++){
var _6a3=this.children[i];
if(_6a3 instanceof dojo.widget.html.Toolbar){
dojo.lang.mixin(_6a1,_6a3.getItemsState());
}
}
return _6a1;
};
...
var _6a4={};
for(var i=0;i<this.children.length;i++){
var _6a6=this.children[i];
if(_6a6 instanceof dojo.widget.html.Toolbar){
dojo.lang.mixin(_6a4,_6a6.getItemsActiveState());
}
}
return _6a4;
};
...
var _6a7={};
for(var i=0;i<this.children.length;i++){
var _6a9=this.children[i];
if(_6a9 instanceof dojo.widget.html.Toolbar){
dojo.lang.mixin(_6a7,_6a9.getItemsSelectedState());
}
}
return _6a7;
};
...
var _6ad=dojo.widget.manager.getWidgetsByFilter(function(w){
...
var _6b0=this._getItem(e.target);
if(_6b0&&_6b0._onmouseover){
_6b0._onmouseover(e);
}
};
this._onmouseout=function(e){
var _6b2=this._getItem(e.target);
if(_6b2&&_6b2._onmouseout){
_6b2._onmouseout(e);
}
};
this._onclick=function(e){
var _6b4=this._getItem(e.target);
if(_6b4&&_6b4._onclick){
_6b4._onclick(e);
}
};
this._onmousedown=function(e){
var _6b6=this._getItem(e.target);
if(_6b6&&_6b6._onmousedown){
_6b6._onmousedown(e);
}
};
this._onmouseup=function(e){
var _6b8=this._getItem(e.target);
if(_6b8&&_6b8._onmouseup){
_6b8._onmouseup(e);
}
};
var _6b9=this.addChild;
this.addChild=function(item,pos,_6bc){
var _6bd=dojo.widget.ToolbarItem.make(item,null,_6bc);
var ret=_6b9.call(this,_6bd,null,pos,null);
return ret;
};
this.push=function(){
for(var i=0;i<arguments.length;i++){
...
for(var i=0;i<this.children.length;i++){
var _6c2=this.children[i];
if(_6c2 instanceof dojo.widget.ToolbarItem&&_6c2._name==name){
return _6c2;
}
}
return null;
...
var _6c3=[];
for(var i=0;i<this.children.length;i++){
var _6c5=this.children[i];
if(_6c5 instanceof dojo.widget.ToolbarItem){
_6c3.push(_6c5);
}
}
return _6c3;
...
var _6c6={};
for(var i=0;i<this.children.length;i++){
var _6c8=this.children[i];
if(_6c8 instanceof dojo.widget.ToolbarItem){
_6c6[_6c8._name]={selected:_6c8._selected,enabled:_6c8._enabled};
}
}
return _6c6;
};
this.getItemsActiveState=function(){
var _6c9=this.getItemsState();
for(var item in _6c9){
_6c9[item]=_6c9[item].enabled;
}
return _6c9;
};
this.getItemsSelectedState=function(){
var _6cb=this.getItemsState();
for(var item in _6cb){
_6cb[item]=_6cb[item].selected;
}
return _6cb;
};
this.enable=function(){
var _6cd=arguments.length?arguments:this.children;
for(var i=0;i<_6cd.length;i++){
var _6cf=this.getItem(_6cd[i]);
if(_6cf instanceof dojo.widget.ToolbarItem){
_6cf.enable(false,true);
}
}
};
this.disable=function(){
var _6d0=arguments.length?arguments:this.children;
for(var i=0;i<_6d0.length;i++){
var _6d2=this.getItem(_6d0[i]);
if(_6d2 instanceof dojo.widget.ToolbarItem){
_6d2.disable();
}
}
};
...
return this._name;
},setName:function(_6dc){
return this._name=_6dc;
},getValue:function(){
return this.getName();
},setValue:function(_6dd){
return this.setName(_6dd);
},_selected:false,isSelected:function(){
return this._selected;
},setSelected:function(is,_6df,_6e0){
if(!this._toggleItem&&!_6df){
return;
}
is=Boolean(is);
if(_6df||this._enabled&&this._selected!=is){
this._selected=is;
this.update();
if(!_6e0){
...
},select:function(_6e1,_6e2){
return this.setSelected(true,_6e1,_6e2);
},deselect:function(_6e3,_6e4){
return this.setSelected(false,_6e3,_6e4);
},_toggleItem:false,isToggleItem:function(){
return this._toggleItem;
},setToggleItem:function(_6e5){
this._toggleItem=Boolean(_6e5);
},toggleSelected:function(_6e6){
return this.setSelected(!this._selected,_6e6);
},_enabled:true,isEnabled:function(){
return this._enabled;
},setEnabled:function(is,_6e8,_6e9){
is=Boolean(is);
if(_6e8||this._enabled!=is){
this._enabled=is;
this.update();
if(!_6e9){
...
return this._enabled;
},enable:function(_6ea,_6eb){
return this.setEnabled(true,_6ea,_6eb);
},disable:function(_6ec,_6ed){
return this.setEnabled(false,_6ec,_6ed);
},toggleEnabled:function(_6ee,_6ef){
return this.setEnabled(!this._enabled,_6ee,_6ef);
},_icon:null,getIcon:function(){
return this._icon;
},setIcon:function(_6f0){
var icon=dojo.widget.Icon.make(_6f0);
if(this._icon){
this._icon.setIcon(icon);
}else{
this._icon=icon;
}
var _6f2=this._icon.getNode();
if(_6f2.parentNode!=this.domNode){
if(this.domNode.hasChildNodes()){
this.domNode.insertBefore(_6f2,this.domNode.firstChild);
}else{
this.domNode.appendChild(_6f2);
}
}
return this._icon;
},_label:"",getLabel:function(){
return this._label;
},setLabel:function(_6f3){
var ret=this._label=_6f3;
if(!this.labelNode){
...
dojo.widget.ToolbarItem.make=function(wh,_700,_701){
var item=null;
if(wh instanceof Array){
item=dojo.widget.createWidget("ToolbarButtonGroup",_701);
item.setName(wh[0]);
...
item=dojo.widget.createWidget("ToolbarButton",dojo.lang.mixin(_701||{},{icon:new dojo.widget.Icon(wh.toString())}));
}else{
if(_700){
item=dojo.widget.createWidget(wh,_701);
}else{
...
case "-":
case "/":
item=dojo.widget.createWidget("ToolbarSeparator",_701);
break;
case " ":
if(wh.length==1){
item=dojo.widget.createWidget("ToolbarSpace",_701);
}else{
item=dojo.widget.createWidget("ToolbarFlexibleSpace",_701);
}
break;
default:
...
item=dojo.widget.createWidget("ToolbarButton",dojo.lang.mixin(_701||{},{label:wh.toString()}));
}
}
}else{
if(wh&&wh.tagName&&/^img$/i.test(wh.tagName)){
item=dojo.widget.createWidget("ToolbarButton",dojo.lang.mixin(_701||{},{icon:wh}));
}else{
item=dojo.widget.createWidget("ToolbarButton",dojo.lang.mixin(_701||{},{label:wh.toString()}));
}
}
...
this.defaultButton="";
var _704=this.addChild;
this.addChild=function(item,pos,_707){
var _708=dojo.widget.ToolbarItem.make(item,null,dojo.lang.mixin(_707||{},{toggleItem:true}));
dojo.event.connect(_708,"onSelect",this,"onChildSelected");
var ret=_704.call(this,_708,null,pos,null);
if(_708._name==this.defaultButton||(typeof this.defaultButton=="number"&&this.children.length-1==this.defaultButton)){
_708.select(false,true);
}
return ret;
};
this.getItem=function(name){
...
for(var i=0;i<this.children.length;i++){
var _70c=this.children[i];
if(_70c instanceof dojo.widget.ToolbarItem&&_70c._name==name){
return _70c;
}
}
return null;
...
var _70d=[];
for(var i=0;i<this.children.length;i++){
var _70f=this.children[i];
if(_70f instanceof dojo.widget.ToolbarItem){
_70d.push(_70f);
}
}
return _70d;
...
this.enable=function(_711,_712){
for(var i=0;i<this.children.length;i++){
var _714=this.children[i];
if(_714 instanceof dojo.widget.ToolbarItem){
_714.enable(_711,_712);
if(_714._name==this._value){
_714.select(_711,_712);
}
}
}
};
this.disable=function(_715,_716){
for(var i=0;i<this.children.length;i++){
var _718=this.children[i];
if(_718 instanceof dojo.widget.ToolbarItem){
_718.disable(_715,_716);
}
}
};
this._value="";
...
this.select=function(name,_71a,_71b){
for(var i=0;i<this.children.length;i++){
var _71d=this.children[i];
if(_71d instanceof dojo.widget.ToolbarItem){
if(_71d._name==name){
_71d.select(_71a,_71b);
this._value=name;
}else{
_71d.deselect(true,_71b);
}
}
}
if(!_71b){
...
var _725=this.fillInTemplate;
this.fillInTemplate=function(args,frag,skip){
_725.call(this,args,frag);
...
var _729=this.fillInTemplate;
this.fillInTemplate=function(args,frag,skip){
_729.call(this,args,frag,true);
if(!skip){
...
var _72d=this.fillInTemplate;
this.fillInTemplate=function(args,frag){
_72d.call(this,args,frag,true);
...
var _735=this.setEnabled;
this.setEnabled=function(is,_737,_738){
var ret=_735.call(this,is,_737,_738);
...
dojo.widget.Icon=function(_73a,_73b,_73c,_73d){
if(arguments.length==0){
throw new Error("Icon must have at least an enabled state");
}
var _73e=["enabled","disabled","hover","selected"];
var _73f="enabled";
var _740=document.createElement("img");
this.getState=function(){
return _73f;
};
this.setState=function(_741){
if(dojo.lang.inArray(_741,_73e)){
if(this[_741]){
_73f=_741;
_740.setAttribute("src",this[_73f].src);
}
}else{
throw new Error("Invalid state set on Icon (state: "+_741+")");
}
};
this.setSrc=function(_742,_743){
if(/^img$/i.test(_743.tagName)){
this[_742]=_743;
}else{
if(typeof _743=="string"||_743 instanceof String||_743 instanceof dojo.uri.Uri){
this[_742]=new Image();
this[_742].src=_743.toString();
}
}
return this[_742];
};
...
if(icon[_73e[i]]){
this.setSrc(_73e[i],icon[_73e[i]]);
}
}
this.update();
};
...
return {width:_740.width||_740.offsetWidth,height:_740.height||_740.offsetHeight};
};
...
this.getSrc=function(_748){
if(_748){
return this[_748].src;
}
return _740.src||"";
};
...
dojo.lang.extend(dojo.widget.HtmlRichText,{widgetType:"richtext",inheritWidth:false,focusOnLoad:true,saveName:"",_content:"",minHeight:"1em",isClosed:true,isLoaded:false,useActiveX:false,_SEPARATOR:"@@**%%__RICHTEXTBOUNDRY__%%**@@",fillInTemplate:function(){
this.open();
var _751=["queryCommandEnabled","queryCommandState","queryCommandValue","execCommand"];
for(var i=0;i<_751.length;i++){
dojo.event.connect("around",this,_751[i],this,"_normalizeCommand");
}
...
dojo.dom.insertAfter(_755.textarea,_755.domNode);
});
}else{
...
if(this.saveName!=""){
var _756=document.getElementById("dojo.widget.RichText.savedContent");
if(_756.value!=""){
var _757=_756.value.split(this._SEPARATOR);
for(var i=0;i<_757.length;i++){
var data=_757[i].split(":");
...
var _75a=["onBlur","onFocus","onKeyPress","onKeyDown","onKeyUp","onClick"];
for(var i=0;i<_75a.length;i++){
this.connect(this.editNode,_75a[i].toLowerCase(),_75a[i]);
}
this.window=window;
...
var _75c=false;
var _75d=dojo.lang.hitch(this,function(){
if(!_75c){
_75c=true;
}else{
return;
...
this.object.DocumentHTML="<!doctype HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\" \"http://www.w3.org/TR/html4/strict.dtd\">"+"<title></title>"+"<style type=\"text/css\">"+"    body,html { padding: 0; margin: 0; }"+"    body { overflow: hidden; }"+"</style>"+"<body><div id=\"bodywrapper\">"+html+"</div></body>";
},onLoad:function(e){
this.isLoaded=true;
if(this.object){
...
var _766=dojo.event.browser.addListener(this.document,"blur",dojo.lang.hitch(this,"onBlur"));
var _767={unBlur:function(e){
dojo.event.browser.removeListener(doc,"blur",_766);
}};
dojo.event.connect("before",this,"close",_767,"unBlur");
dojo.event.browser.addListener(this.document,"focus",dojo.lang.hitch(this,"onFocus"));
var _769=dojo.event.browser.addListener;
_769(this.document,"keypress",dojo.lang.hitch(this,"onKeyPress"));
_769(this.document,"keydown",dojo.lang.hitch(this,"onKeyDown"));
_769(this.document,"keyup",dojo.lang.hitch(this,"onKeyUp"));
_769(this.document,"click",dojo.lang.hitch(this,"onClick"));
}
}
}
}
...
var _76d=e.charCode>0?String.fromCharCode(e.charCode):null;
var code=e.keyCode;
var _76f=true;
...
return _775.proceed();
},queryCommandAvailable:function(_779){
var ie=1;
var _77b=1<<1;
var _77c=1<<2;
var _77d=1<<3;
function isSupportedBy(_77e){
return {ie:Boolean(_77e&ie),mozilla:Boolean(_77e&_77b),safari:Boolean(_77e&_77c),opera:Boolean(_77e&_77d)};
}
var _77f=null;
switch(_779.toLowerCase()){
case "bold":
case "italic":
case "underline":
case "subscript":
...
case "undo":
case "redo":
_77f=isSupportedBy(_77b|ie|_77c|_77d);
break;
case "createlink":
case "unlink":
case "removeformat":
...
case "formatblock":
case "strikethrough":
_77f=isSupportedBy(_77b|ie|_77d);
break;
case "blockdirltr":
case "blockdirrtl":
case "dirltr":
...
case "inlinedirltr":
case "inlinedirrtl":
_77f=isSupportedBy(ie);
break;
case "inserttable":
_77f=isSupportedBy(_77b|(this.object?ie:0));
break;
case "insertcell":
case "insertcol":
case "insertrow":
...
case "mergecells":
case "splitcell":
_77f=isSupportedBy(this.object?ie:0);
break;
default:
return false;
}
return (dojo.render.html.ie&&_77f.ie)||(dojo.render.html.mozilla&&_77f.mozilla)||(dojo.render.html.safari&&_77f.safari)||(dojo.render.html.opera&&_77f.opera);
},execCommand:function(_780,_781){
if(this.object){
if(_780=="forecolor"){
_780="setforecolor";
}else{
...
if(_780=="inserttable"){
var _782=this.constructor._tableInfo;
if(!_782){
_782=document.createElement("object");
_782.classid="clsid:47B0DFC7-B7A3-11D1-ADC5-006008A5848C";
document.body.appendChild(_782);
this.constructor._table=_782;
}
_782.NumRows=_781.rows;
_782.NumCols=_781.cols;
_782.TableAttrs=_781["TableAttrs"];
_782.CellAttrs=arr["CellAttrs"];
_782.Caption=arr["Caption"];
}
if(arguments.length==1){
return this.object.ExecCommand(this._activeX.command[_780],this._activeX.ui.noprompt);
}else{
return this.object.ExecCommand(this._activeX.command[_780],this._activeX.ui.noprompt,_781);
}
}else{
if(_780=="unlink"&&this.queryCommandEnabled("unlink")&&dojo.render.html.mozilla){
var _783=this.window.getSelection();
var _784=_783.getRangeAt(0);
var _785=_784.startContainer;
var _786=_784.startOffset;
var _787=_784.endContainer;
var _788=_784.endOffset;
var _789=document.createRange();
var a=this.getSelectedNode();
while(a.nodeName!="A"){
a=a.parentNode;
}
_789.selectNode(a);
_783.removeAllRanges();
_783.addRange(_789);
var _78b=this.document.execCommand("unlink",false,null);
var _784=document.createRange();
_784.setStart(_785,_786);
_784.setEnd(_787,_788);
_783.removeAllRanges();
_783.addRange(_784);
return _78b;
}else{
if(_780=="inserttable"&&dojo.render.html.mozilla){
var cols="<tr>";
for(var i=0;i<_781.cols;i++){
cols+="<td></td>";
}
cols+="</tr>";
var _78e="<table><tbody>";
for(var i=0;i<_781.rows;i++){
_78e+=cols;
}
_78e+="</tbody></table>";
var _78b=this.document.execCommand("inserthtml",false,_78e);
}else{
if(_780=="hilitecolor"&&dojo.render.html.mozilla){
this.document.execCommand("useCSS",false,false);
var _78b=this.document.execCommand(_780,false,_781);
this.document.execCommand("useCSS",false,true);
}else{
_781=arguments.length>1?_781:null;
var _78b=this.document.execCommand(_780,false,_781);
}
}
}
...
this.onDisplayChanged();
return _78b;
},queryCommandEnabled:function(_78f,_790){
if(this.object){
if(_78f=="forecolor"){
_78f="setforecolor";
}else{
...
if(typeof this._activeX.command[_78f]=="undefined"){
return false;
}
var _791=this.object.QueryStatus(this._activeX.command[_78f]);
return (_791!=this.activeX.status.notsupported&&_791!=this.activeX.status.diabled);
}else{
if(_78f=="unlink"&&dojo.render.html.mozilla){
...
if(_78f=="inserttable"&&dojo.render.html.mozilla){
return true;
}
}
return this.document.queryCommandEnabled(_78f);
}
},queryCommandState:function(_793,_794){
if(this.object){
if(_793=="forecolor"){
_793="setforecolor";
}else{
...
if(typeof this._activeX.command[_793]=="undefined"){
return null;
}
var _795=this.object.QueryStatus(this._activeX.command[_793]);
return (_795==this._activeX.status.enabled||_795==this._activeX.status.ninched);
}else{
return this.document.queryCommandState(_793);
}
},queryCommandValue:function(_796,_797){
if(this.object){
switch(_796){
case "forecolor":
case "backcolor":
...
case "blockformat":
_796="get"+_796;
return this.object.execCommand(this._activeX.command[_796],this._activeX.ui.noprompt);
}
}else{
return this.document.queryCommandValue(_796);
}
...
var _798=this.window.getSelection;
if(_798.removeAllRanges){
var _799=this.document.createRange();
_799.selectNode(this.editNode.firstChild);
_799.collapse(true);
var _798=this.window.getSelection();
...
if(this.document.selection){
var _799=this.document.body.createTextRange();
_799.moveToElementText(this.editNode);
_799.collapse(true);
_799.select();
}
}
...
dojo.event.disconnect(this,"onLoad",this,"placeCursorAtEnd");
if(this.window.getSelection){
var _79a=this.window.getSelection;
if(_79a.removeAllRanges){
var _79b=this.document.createRange();
_79b.selectNode(this.editNode.lastChild);
_79b.collapse(false);
var _79a=this.window.getSelection();
...
if(this.document.selection){
var _79b=this.document.body.createTextRange();
_79b.moveToElementText(this.editNode);
_79b.collapse(true);
_79b.select();
}
}
...
if(this.iframe){
var _79c=["margin-top","margin-bottom","padding-bottom","padding-top","border-width-bottom","border-width-top"];
for(var i=0,chromeheight=0;i<_79c.length;i++){
var _79e=dojo.style.getStyle(this.iframe,_79c[i]);
if(_79e){
chromeheight+=Number(_79e.replace(/[^0-9]/g,""));
}
}
...
_7a0.value+=this._SEPARATOR+this.saveName+":"+this.getEditorContent();
...
var _7a5=(this.savedContent.innerHTML!=this._content);
if(this.iframe){
...
},_connected:[],connect:function(_7a8,_7a9,_7aa){
dojo.event.connect(_7a8,_7a9,this,_7aa);
},disconnect:function(_7ab,_7ac,_7ad){
for(var i=0;i<this._connected.length;i++){
if(this._connected[0]==_7ab&&this._connected[1]==_7ac&&this._connected[2]==_7ad){
dojo.event.disconnect(_7ab,_7ac,this,_7ad);
this._connected.splice(i,1);
break;
}
}
},disconnectAllWithRoot:function(_7af){
for(var i=0;i<this._connected.length;i++){
if(this._connected[0]==_7af){
dojo.event.disconnect(_7af,this._connected[1],this,this._connected[2]);
this._connected.splice(i,1);
}
}
}});
...
dojo.widget.html.ToolbarDialog.call(this);
for(var _7b1 in this.constructor.prototype){
this[_7b1]=this.constructor.prototype[_7b1];
}
};
...
},_setValue:function(_7b4){
this._value=_7b4;
this._fireEvent("onSetValue",_7b4);
},showDialog:function(e){
...
var _7ba=document.createElement("tbody");
this.domNode.appendChild(_7ba);
var _7bb=this.palettes[this.palette];
for(var i=0;i<_7bb.length;i++){
var tr=document.createElement("tr");
for(var j=0;j<_7bb[i].length;j++){
if(_7bb[i][j].length==3){
_7bb[i][j]=_7bb[i][j].replace(/(.)(.)(.)/,"$1$1$2$2$3$3");
}
var td=document.createElement("td");
with(td.style){
backgroundColor="#"+_7bb[i][j];
...
dojo.widget.html.Editor.itemGroups={textGroup:["bold","italic","underline","strikethrough"],blockGroup:["formatBlock","fontName"],justifyGroup:["justifyleft","justifycenter","justifyright"],commandGroup:["save","cancel"],colorGroup:["forecolor","hilitecolor"],listGroup:["insertorderedlist","insertunorderedlist"],indentGroup:["outdent","indent"],linkGroup:["createlink","insertimage"]};
dojo.widget.html.Editor.formatBlockValues={"Normal":"p","Main heading":"h2","Sub heading":"h3","Sub sub headering":"h4","Preformatted":"pre"};
...
dojo.widget.html.Editor.defaultItems=["commandGroup","|","linkGroup","|","textGroup","|","justifyGroup","|","listGroup","indentGroup","|","colorGroup"];
dojo.widget.html.Editor.supportedCommands=["save","cancel","|","-","/"," "];
dojo.lang.extend(dojo.widget.html.Editor,{widgetType:"Editor",items:dojo.widget.html.Editor.defaultItems,formatBlockItems:dojo.lang.shallowCopy(dojo.widget.html.Editor.formatBlockValues),fontNameItems:dojo.lang.shallowCopy(dojo.widget.html.Editor.fontNameValues),getItemProperties:function(name){
var _7c7={};
...
case "underline":
case "strikethrough":
_7c7.toggleItem=true;
break;
case "justifygroup":
_7c7.defaultButton="justifyleft";
_7c7.preventDeselect=true;
_7c7.buttonGroup=true;
break;
case "listgroup":
_7c7.buttonGroup=true;
break;
case "save":
case "cancel":
_7c7.label=dojo.string.capitalize(name);
break;
case "forecolor":
case "hilitecolor":
_7c7.name=name;
_7c7.toggleItem=true;
_7c7.icon=this.getCommandImage(name);
break;
case "formatblock":
_7c7.name="formatBlock";
_7c7.values=this.formatBlockItems;
break;
case "fontname":
_7c7.name="fontName";
_7c7.values=this.fontNameItems;
}
return _7c7;
...
var _7cc=this;
setTimeout(function(){
_7cc.setRichText(trt);
_7cc.initToolbar();
_7cc.fillInTemplate(args,frag);
},0);
},setRichText:function(_7cd){
if(this._richText&&this._richText==_7cd){
...
},insertToolbar:function(_7d1,_7d2){
dojo.html.insertBefore(_7d1,_7d2);
},addToolbar:function(_7d3){
this.initToolbar();
if(!(_7d3 instanceof dojo.widget.html.Toolbar)){
_7d3=dojo.widget.createWidget(this._toolbarType);
}
this._toolbarContainer.addChild(_7d3);
this._toolbars.push(_7d3);
return _7d3;
},addItem:function(item,tb,_7d6){
if(!tb){
tb=this._toolbars[0];
}
var cmd=((item)&&(!dojo.lang.isUndefined(item["getValue"])))?cmd=item["getValue"]():item;
var _7d8=dojo.widget.html.Editor.itemGroups;
if(item instanceof dojo.widget.ToolbarItem){
tb.addChild(item);
}else{
if(_7d8[cmd]){
...
if(_7d6||this.isSupportedCommand(_7d9[i])){
_7db.push(this.getCommandImage(_7d9[i]));
}else{
_7da=false;
}
}
if(_7db.length){
var btn=tb.addChild(_7db,null,this.getItemProperties(cmd));
...
if((!_7d6)&&(!this.isSupportedCommand(cmd))){
return false;
}
if(_7d6||this.isSupportedCommand(cmd)){
cmd=cmd.toLowerCase();
if(cmd=="formatblock"){
var _7de=dojo.widget.createWidget("ToolbarSelect",{name:"formatBlock",values:this.formatBlockItems});
tb.addChild(_7de);
var _7df=this;
dojo.event.connect(_7de,"onSetValue",function(item,_7e1){
_7df.onAction("formatBlock",_7e1);
});
}else{
if(cmd=="fontname"){
var _7de=dojo.widget.createWidget("ToolbarSelect",{name:"fontName",values:this.fontNameItems});
tb.addChild(_7de);
dojo.event.connect(_7de,"onSetValue",dojo.lang.hitch(this,function(item,_7e3){
this.onAction("fontName",_7e3);
}));
}else{
...
},_updateToolbarLastRan:null,_updateToolbarTimer:null,_updateToolbarFrequency:500,updateToolbar:function(_7e5){
if(!this._toolbarContainer){
return;
}
var diff=new Date()-this._updateToolbarLastRan;
if(!_7e5&&this._updateToolbarLastRan&&(diff<this._updateToolbarFrequency)){
...
var _7e8=this._toolbarContainer.getItems();
...
var _7ec=item.getItems();
for(var j=0;j<_7ec.length;j++){
var name=_7ec[j]._name;
var _7ef=this._richText.queryCommandValue(name);
if(typeof _7ef=="boolean"&&_7ef){
_7ef=name;
break;
}else{
if(typeof _7ef=="string"){
_7ef="justify"+_7ef;
}else{
_7ef=null;
}
...
if(cmd=="listGroup"){
var _7f0=item.getItems();
for(var j=0;j<_7f0.length;j++){
this.updateItem(_7f0[j]);
}
}else{
...
try{
var cmd=item._name;
var _7f3=this._richText.queryCommandEnabled(cmd);
item.setEnabled(_7f3,false,true);
var _7f4=this._richText.queryCommandState(cmd);
if(_7f4&&cmd=="underline"){
_7f4=!this._richText.queryCommandEnabled("unlink");
}
item.setSelected(_7f4,false,true);
return true;
}
catch(err){
return false;
...
if(!yes){
try{
var _7f7=this._richText||dojo.widget.html.RichText.prototype;
yes=_7f7.queryCommandAvailable(cmd);
}
catch(E){
}
}
...
},onAction:function(cmd,_7fe){
switch(cmd){
case "createlink":
if(!(_7fe=prompt("Please enter the URL of the link:","http://"))){
return;
}
break;
case "insertimage":
if(!(_7fe=prompt("Please enter the URL of the image:","http://"))){
return;
}
break;
}
this._richText.execCommand(cmd,_7fe);
},fillInTemplate:function(args,frag){
},_fire:function(_801){
if(dojo.lang.isFunction(this[_801])){
var args=[];
if(arguments.length==1){
args.push(this);
}else{
