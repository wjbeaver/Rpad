...
#############################################################################
## Name:        Win32.pm
## Purpose:     Statistics::Rpad::Bridge::Win32
...
#############################################################################
  ...
  use Statistics::Rpad::Bridge::pipe ;

{ package Statistics::Rpad::Bridge::Win32 ;

  use strict qw(vars) ; no warnings ;

  use vars qw(@ISA) ; push(@ISA , qw(Statistics::Rpad::Bridge::pipe UNIVERSAL)) ;
  ...
  sub find_file { my $CLASS_HPLOO ;$CLASS_HPLOO = $this if defined $this ;my $this = UNIVERSAL::isa($_[0],'UNIVERSAL') ? shift : $CLASS_HPLOO ;my $class = ref($this) || __PACKAGE__ ;$CLASS_HPLOO = undef ; &Statistics::Rpad::Bridge::find_file ;}
  sub cat_dir { my $CLASS_HPLOO ;$CLASS_HPLOO = $this if defined $this ;my $this = UNIVERSAL::isa($_[0],'UNIVERSAL') ? shift : $CLASS_HPLOO ;my $class = ref($this) || __PACKAGE__ ;$CLASS_HPLOO = undef ; &Statistics::Rpad::Bridge::cat_dir ;}
  sub error { my $CLASS_HPLOO ;$CLASS_HPLOO = $this if defined $this ;my $this = UNIVERSAL::isa($_[0],'UNIVERSAL') ? shift : $CLASS_HPLOO ;my $class = ref($this) || __PACKAGE__ ;$CLASS_HPLOO = undef ; &Statistics::Rpad::error ;}
...
Statistics::Rpad::Bridge::Win32 - Handles R on Win32.
...
L<Statistics::Rpad>, L<Statistics::Rpad::Bridge>.
