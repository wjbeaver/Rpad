...
#############################################################################
## Name:        Bridge.pm
## Purpose:     Statistics::Rpad::Bridge
...
{ package Statistics::Rpad::Bridge ;
  ...
  sub Bridge { 
    ...
    if ( $^O =~ /^(?:.*?win32|dos)$/i ) {
      require Statistics::Rpad::Bridge::Win32 ;
      $this->{OS} = Statistics::Rpad::Bridge::Win32->new(%args) ;
    }
    else {
      require Statistics::Rpad::Bridge::Linux ;
      $this->{OS} = Statistics::Rpad::Bridge::Linux->new(%args) ;
    }
...
Statistics::Rpad::Bridge - Implements a communication bridge between Perl and R (R-project).
...
B<You shouldn't use this directly. See L<Statistics::Rpad> for usage.>
